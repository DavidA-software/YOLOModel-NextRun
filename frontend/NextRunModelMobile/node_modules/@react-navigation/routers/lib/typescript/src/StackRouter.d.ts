import type { DefaultRouterOptions, NavigationRoute, NavigationState, ParamListBase, Router } from '@react-navigation/routers/lib/typescript/src/types.js';
...
export declare function StackRouter(options: StackRouterOptions): Router<StackNavigationState<ParamListBase>, import("@react-navigation/routers/lib/typescript/src/CommonActions.js").Action | StackActionType>;
