...
import type { DefaultNavigatorOptions, EventMapBase, NavigationListBase, NavigatorScreenParams, NavigatorTypeBagBase, PathConfig, PathConfigMap, RouteConfigComponent, RouteConfigProps, RouteGroupConfig, StaticParamList } from '@react-navigation/core/lib/typescript/src/types.js';
export type { StaticParamList } from '@react-navigation/core/lib/typescript/src/types.js';
