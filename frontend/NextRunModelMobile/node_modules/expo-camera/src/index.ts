...
import { BarcodeScanningResult, BarcodeType } from 'expo-camera/src/Camera.types';
import CameraManager from 'expo-camera/src/ExpoCameraManager';

export { default as CameraView } from 'expo-camera/src/CameraView';
...
export * from 'expo-camera/src/Camera.types';
export * from 'expo-camera/src/PictureRef';
