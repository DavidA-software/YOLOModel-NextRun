...
import { CameraCapturedPicture, CameraOrientation, CameraPictureOptions, CameraViewProps, CameraRecordingOptions, CameraViewRef, ScanningOptions, ScanningResult, VideoCodec, AvailableLenses } from 'expo-camera/build/Camera.types';
import { PictureRef } from 'expo-camera/build/PictureRef';
export default class CameraView extends Component<CameraViewProps> {
    ...
    static ConversionTables: {
        [prop: string]: unknown;
        type: Record<keyof import("expo-camera/build/Camera.types").CameraType, import("expo-camera/build/Camera.types").CameraNativeProps["facing"]>;
        flash: Record<keyof import("expo-camera/build/Camera.types").FlashMode, import("expo-camera/build/Camera.types").CameraNativeProps["flashMode"]>;
    };
